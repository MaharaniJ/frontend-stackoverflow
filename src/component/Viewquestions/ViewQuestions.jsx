...
function ViewQuestions() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (data !== "") {
      ...
      await axios
        .post(
          "https://backend-stackoverflow-x2hh.onrender.com/api/answer",
          parsedData
        )
        .then((res) => {
          setloading(false);
      ...
      <div className="view-questions">
        <div className="view-question-header">
          <div className="view-question-title">
            ...
            <Link to="/AskQuestion" className="view-question-ask-button">
              Ask Question
            </Link>
          </div>
          ...
          <div className="qestion-vie-details">
            <small>
              ...
              <span>
                {Math.round(
                  (new Date().getTime() -
                    new Date(question && question.createdAt).getTime()) /
                    86400000
                )}{" "}
                days ago
              </span>
        ...
        <div className="view-question-body">
          ...
          <div className="view-question-body-right">
            ...
            <div className="question-tags">
              {Array.isArray(tags) ? (
                tags.map((tag, i) => (
                  <a key={i} className="question-tag" href="/">
                    {tag}
                  </a>
                ))
              ) : (
          ...
          <div className="view-question-avatar-details">
            <div className="auth-avatar">
              <Avatar src={question && question.user.photo} />{" "}
              <span>{question && question.user.displayName}</span>
            </div>
          </div>
        </div>
            ...
            return (
              <div className="ans-body">
                <div className="view-question-body">
                  ...
                  <div className="view-question-avatar-details">
                    <div className="auth-avatar">
                      <Avatar src={answer && answer.user.photo} />{" "}
                      <span>{answer && answer.user.displayName}</span>
                      <p>
                        {new Date(
        ...
        {fieldError && (
          <p style={{ color: "red" }}>
            Please fill in the Title and Body field.
          </p>
        )}
      </div>
    </>
