    ...
    <>
      <div className="allQuestions">
        ...
        <div className="questions-middleContent">
          <Link to={`/ViewQuestion?q=${props._id}`} className="quest">
            {props.title}
          </Link>
          <div className="question-tags">
            {Array.isArray(tags) ? (
              tags.map((tag) => (
                <a className="question-tag" href="/">
                  {tag}
                </a>
              ))
            ) : (
...
AllQuestions.defaultProps = {
  ...
  views: 0,
  title:
    "How to remove alpha in beta? fgpokdfgnhfd hdf j yj  gtj rt, jrytjytjtyy j ghbdfgj tyj fdhfdrhrgjq erh ewghr ewugrh ergh equrhg qwrgh qewrgh qierghqrg hqwri we;irgu ir tgqwirh ;ieare;ir hw; reirguihfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfg fgfgfgfgfgfgfgf gfgfgfgfgfgfgfgfgfgfgf gfgfgfgfgfgfg gf   ",
};
